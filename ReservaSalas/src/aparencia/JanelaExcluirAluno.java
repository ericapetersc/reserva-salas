 ...
 * @author ericapetersc
 */
public class JanelaExcluirAluno extends javax.swing.JFrame {
    ...
    private void ExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExcluirActionPerformed
        switch(JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir esse usuário?")){
            case 0:
                boolean res = negocio.NegocioFacade.excluirUsuario(cpf);
                if(res){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaExcluirAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaExcluirAluno().setVisible(true);
            }
        });
    }
