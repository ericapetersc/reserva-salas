...
public class ViewListarSalas extends javax.swing.JFrame {

    private static ViewListarSalas instance;
    SalaController controller = new SalaController();
    
    private ViewListarSalas() {
        initComponents();
    }
    
    public static ViewListarSalas getInstance(){
        if(instance==null)
            instance=new ViewListarSalas();
        instance.carregarSalas();
        return instance;
    }

    public void carregarSalas(){
        List<Sala> lista = controller.listaTodas();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewListarSalas().setVisible(true);
            }
        });
    }
