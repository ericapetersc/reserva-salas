 ...
 * @author Ediana
 */
public class ViewExcluirReserva extends javax.swing.JFrame {
    private String codigo;
    private int CodigoSala;
    private static ViewExcluirReserva instance;
    private ReservaController controller = new ReservaController();
    
    public ViewExcluirReserva() {
        initComponents();
    }
    
    public static ViewExcluirReserva getInstance(){
        if (instance==null)
            instance = new ViewExcluirReserva();
    ...
    public void popularComboBox(){
        ...
        if (reservas.size()==0){
            ...
            while (!reservas.isEmpty()){
                ...
                combo.addItem(r.getCodigo() + " - " + r.getCPF());
                reservas.remove(0);
            }
    ...
    public void avisoErroExcluir(){
        JOptionPane.showMessageDialog(null, "Houve um erro. Não foi possível excluir a reserva.");
    }
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        ...
        int idSala = controller.ConsultaReservaExluir();
        controller.consultarSalaExcluir(idSala);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int resposta = JOptionPane.showConfirmDialog(null, "Você realmente deseja excluir essa reserva?", "Cancelar", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if( resposta == JOptionPane.YES_OPTION ){
            controller.excluiReserva();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewExcluirReserva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewExcluirReserva().setVisible(true);
            }
        });
    }
